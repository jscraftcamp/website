    ...
    <div className="container">
      <div className="row">
        <div className="col s12 m12">
          ...
          <p>
            To register for JSCraftCamp you have to add a json file with your
            name and some other information to our{" "}
            <a
          ...
          <p>
            ...
            <code>npm test</code> (more details about this are in the{" "}
            <a
            ...
            <br />
            If you need any help with registration, don't hesitate to contact
            one of <a href="./theteam">the team</a>.
          </p>
          <p>
            Out of these files a page with information about{" "}
            <Link to="/participants">all participants</Link> will be generated.
          </p>
          <p></p>
          <p>
