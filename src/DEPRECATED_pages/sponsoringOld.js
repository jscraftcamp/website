...
const data = [
  {
    name: "Venue",
    priceRange: "room for ~100 people",
    icon: "home",
    sponsor: "Virtual Identity",
    issueId: 548,
  },
  {
    name: "Beverages",
  ...
  {
    name: "Coffee",
    priceRange: "~300 € (depends on quality)",
    icon: "local_cafe",
    sponsor: "Peerigon",
    issueId: 558,
  },
...
export default () => (
  <Layout>
      ...
      <div className="row flow-text">
        <div className="col s12 m6">
          ...
          <ul className="real_list">
            <li>
              Get up to <b>5 preregistered participant spots</b> for your
              representatives
            </li>
            <li>
              We place your <b>logo</b> and <b>link</b> on the JSCraftCamp
              website
            </li>
            <li>
              Your <b>exhibitor</b> will be visible for the whole time during
              the event
            </li>
            <li>
              Your <b>company name</b> will be mentioned several times during
              the conference
            </li>
            <li>
              It's an OpenSpace &mdash; contribute the{" "}
              <b>talks that are important to you</b> to the community
            </li>
            <li>
              Sponsors will be announced via the official JSCC <b>Twitter</b>{" "}
              account
            </li>
          </ul>
        </div>
        <div className="col s12 m6">
          ...
          <p className="block">
            ...
            technology and improvement. You will get the chance to present your
            brand to these 100 to 120 highly skilled individuals and show them
            how much you care! We'll all thank you for that!
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      <h2 className="header center" id="what-to-sponsor">
        What to Sponsor?
      </h2>
    ...
    <div className="card small">
      ...
      <div
        className={`card-image center ${
          needsSponsor ? "orange-text" : "grey-text"
        }`}
      >
        <i
          style={{
          ...
          className="sponsor_image material-icons"
        >
          {icon}
        </i>
      </div>
      <div className="card-content">
        <span className="card-title activator">{name}</span>
        <p>{priceRange}</p>
      </div>
      <div className="card-action">
        <div className="card-tags-container center">
          {needsSponsor && (
            <a
              href={"https://github.com/jscraftcamp/website/issues/" + issueId}
            >
              Sponsor this!
              <br />
              Click for details
              <br /> and to contact us.
            </a>
          )}
          {!needsSponsor && (
            <>
