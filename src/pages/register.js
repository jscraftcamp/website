    ...
    <Section>
      <TextBlock headline="Registration">
        <Typography paragraph>
          ...
          and some other information to our <a
        ...
        >
          Pull Request
        </a>. Registration is free of charge. Your json file should follow
          the naming scheme <code>$firstname_$lastname.json</code> and must be placed in the
          folder <code>participants</code>. The structure of the file is described below.
        </Typography>

        <Typography paragraph>
          To test if your json file is a valid registration you can run <code>npm test</code>
          (more details about this are in the <a
          href="https://github.com/jscraftcamp/website/blob/master/README.md"
          rel="noreferrer noopener"
          target="_blank"
        >
          README
        </a>). Invalid registrations
          will be rejected. If you need any help with registration, don't
          hesitate to contact one of the <Link to="/theteam">team</Link>
        </Typography>
        ...
        <Typography>
          To unregister please write another pull request or <a href="mailto:team@jscraftcamp.org">let us know</a>.
        </Typography>
      </TextBlock>
...
`,
      ...
      <div className="col s12 m12" style={{ background: "white" }}>
        ...
        <p>*: mandatory field</p>
        <p>
          **: This is a free and completely sponsored event. Even though we
          want to try, we can not guarantee to be able to respect every
          dietary requirement
        </p>
      </div>
