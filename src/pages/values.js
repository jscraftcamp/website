      ...
      <div className="row flow-text">
        <div className="col s12 l10 offset-l1">
          ...
          <p className="block">
            ...
            everybody than to be <strong>respectful</strong> and{" "}
            <strong>friendly</strong> with one another.
          </p>
          <p className="block">
            And so we invite all those who participate in the JSCraftCamp and
            the community surrounding the conference to help us create safe and
            positive experiences for everyone.
          </p>
          <p>
            If you have any questions or problems regarding this Code of
            Conduct, don't hesitate to contact one of us from{" "}
