<script lang="ts">
	...
	const shirtKinds: Array<TShirtSize> = ['S', 'M', 'L', 'XL', '2XL', '3XL'];
	const amountOfShirts = (
		shirts: Partial<Record<TShirtSize, number>>,
		which: TShirtSize
	): number => {
...
<PageLayout>
	<Content>
		<div class="flex items-center justify-between">
			<h1>Statistics of JSCC24</h1>
			<a
				href="{base}/archive/2024"
