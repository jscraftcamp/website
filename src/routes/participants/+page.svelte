	...
	<div class="flex flex-col gap-4">
		<div class="flex flex-col gap-3 sm:flex-row sm:items-center">
			<div class="flex flex-wrap items-center gap-3">
				...
				>
					Friday
					<span class="ml-1 opacity-70">({participants.filter(fridayFilter).length}/{eventConfig.maxParticipantsPerDay})</span>
				</button>
				<button
					type="button"
				...
				>
					Saturday
					<span class="ml-1 opacity-70">({participants.filter(saturdayFilter).length}/{eventConfig.maxParticipantsPerDay})</span>
				</button>
			</div>
			<a
