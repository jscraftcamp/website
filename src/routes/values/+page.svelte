...
<PageLayout>
	<Content>
		...
		<Card>
			...
			<ul>
				<li>
					Treat all attendees as equals. We&#39;re all human. Don&#39;t talk down to others,
					don&#39;t harass them because they don&#39;t share your views. Assume the person standing
					next to you is at least as capable as you are.
				</li>
				<li>
					Be welcoming, friendly and patient. Treat everyone you meet like you want to be treated.
					Ask questions before jumping to conclusions.
				</li>
				<li>
					Be professional and respectful. Disagreements are for learning, not for degrading others
					or proving a point. If you notice that you&#39;re getting in a heated argument, please
					take a step back, reflect on what is being said and work with sending messages that start
					with &quot;I believe/think/see&quot;.
				</li>
				<li>
				...
				<li>
					...
					&quot;guys&quot;, use &quot;folks&quot; or &quot;friends&quot; instead. If someone tells
					you that a term you used is exclusionary, don&#39;t feel bad. Fix it next time and think
					about doing a session on it.
				</li>
			</ul>
		</Card>
		<Card>
			<h3>Don't</h3>
			<p>
				The following is an incomplete list of unacceptable behaviour. Violating this will
				definitely lead to consequences.
			</p>
			<ul>
		...
		<Card>
			<h3>Help Needed</h3>
			<p>
				Accept feedback gracefully, if someone tells you something was not okay. Take it as a
				learning opportunity, do not automatically get defensive.
			</p>
