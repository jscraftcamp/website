...
const ExplainSponsoring = () => (
  <Section className={style.root}>
    ...
    <div className={style.grid}>
      <div>
        ...
        <ul>
          ...
          <li>
            Your <strong>exhibitor</strong> will be visible for the whole time
            during the event
          </li>
          <li>
            You can bring a <strong>stand-up display</strong> to be permanently
            visible.
          </li>
          <li>
    ...
    <Typography paragraph>
      Show how much you care about improving the state of Crafting Software and
      Clean Code in the JS-Community!
    </Typography>

    <Typography paragraph>
      We believe in people and our guests - so we ask nothing more of everybody
      than to be respectful and friendly with one another.
    </Typography>
    <Spacer size="xs" />
    ...
    <Typography paragraph>
      All expense will serve the attendees of the JSCraftCamp, all the expenses
      serve for food, drinks, chairs, and all alike things that are needed for
      spending a couple of days together thinking and hacking for the modern
      world.
    </Typography>
    <Spacer size="xs" />
