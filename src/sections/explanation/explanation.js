    ...
    <div className={style.root}>
      ...
      >
        <Typography paragraph>
          ...
          transpile to JavaScript, server-side programming with node.js,
          paradigms like event driven programming or future technologies like
          WebAssembly.
        </Typography>
      </TextBlock>
      <TextBlock
      ...
      >
        <Typography paragraph>
          ...
          rolled your eyes about an 'undefined' is not a function error? We will
          discuss which tools, practices and architecture patterns – from
          continuous integration to modular components – can help to create and
      ...
      >
        <Typography paragraph>
          ...
          to make everything as participative as possible. Read more about
